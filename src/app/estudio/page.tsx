          ...
          <div className="w-full max-w-[1470px] mx-auto px-6 sm:px-8 lg:px-12">
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-16 items-end">
              ...
              <p className="lg:col-span-4 max-w-md type-body text-neutral-400 animate-rise-in rise-delay-3">
                Creemos que la tecnología moderna no debe ser un lujo reservado a
                grandes corporaciones. Existimos para dotar a pequeños y medianos
                negocios de herramientas digitales sólidas, webs de alto impacto
                y automatizaciones que ahorran horas de trabajo.
              </p>
            </div>
          </div>
        </section>
