  ...
  return (
    ...
    >
      <div className="w-full max-w-[1470px] mx-auto px-6 sm:px-8 lg:px-12 flex flex-col items-center text-center space-y-8 sm:space-y-10">
        ...
        <Reveal className="flex items-center gap-2 font-sans text-base sm:text-lg uppercase tracking-wider text-ink-muted font-medium">
          <Image
            ...
            className="h-[0.73em] w-auto brightness-0"
          />
